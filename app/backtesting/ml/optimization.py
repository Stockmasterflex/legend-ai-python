...
class HyperparameterOptimizer:
    ...
    async def _genetic_search(
        ...
        logger.info(f"Genetic search: {population_size} population, {n_generations} generations")
        ...
        for gen in range(n_generations):
            ...
            for params in population:
                try:
                    ...
                    scores.append((params, float('-inf') if self.config.maximize else float('inf')))
    ...
    def _compile_results(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "parameter_importance": self._calculate_parameter_importance(completed_trials),
        }
        ...
        for param_name, param_values in self.config.parameter_space.items():
            ...
            if len(value_scores) > 1:
                ...
                if group_means:
                    ...
                    between_var = sum((m - global_mean) ** 2 for m in group_means) / len(group_means)
