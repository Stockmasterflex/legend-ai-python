...
class TelegramBot:
    ...
    async def send_alert(self, alert: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            result = await send_telegram_message(
                chat_id=int(self.chat_id), text=message, parse_mode="Markdown"
            )
            ...
            if result:
                ...
                logger.warning(
                    f"Failed to send Telegram alert for {alert.get('ticker')}"
                )
                return False
    ...
    async def send_message(self, text: str) -> bool:
        ...
        try:
            ...
            result = await send_telegram_message(
                chat_id=int(self.chat_id), text=text, parse_mode="Markdown"
            )
