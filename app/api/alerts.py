...
class AlertConfigRequest(BaseModel):
    ...
    min_confidence: float = (
        0.75  # Only alert on patterns with this confidence or higher
    )
        ...
        if request.action == "start":
            ...
            return AlertResponse(
                ...
                details={
                    ...
                    or alert_service.min_confidence_threshold,
            ...
            return AlertResponse(
                ...
                details={
                    "note": "Monitoring stop functionality will be implemented soon"
                },
            )
        ...
        return {
            ...
            "config": {
                ...
                "telegram_enabled": bool(
                    alert_service.telegram_api_key and alert_service.telegram_chat_id
                ),
                "email_enabled": bool(
                    alert_service.sendgrid_api_key and alert_service.alert_email
                ),
