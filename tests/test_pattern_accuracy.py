...
from app.core.pattern_engine.patterns import find_double_bottoms
...
class TestDoubleBottomAccuracy:
    ...
    def test_double_bottom_entry_is_peak(self):
        ...
        if len(patterns) > 0:
            ...
            assert pattern["entry"] == pytest.approx(
                110.0, abs=0.01
    ...
    def test_double_bottom_stop_below_bottoms(self):
        ...
        if len(patterns) > 0:
            ...
            assert pattern["stop"] == pytest.approx(
    ...
    def test_double_bottom_target_measure_move(self):
        ...
        if len(patterns) > 0:
            ...
            assert pattern["target"] == pytest.approx(
                expected_target, abs=0.01
    ...
    def test_double_bottom_risk_reward(self):
        ...
        if len(patterns) > 0:
            ...
            assert pattern["risk_reward"] == pytest.approx(
                expected_rr, abs=0.01
    ...
    def test_risk_reward_formula(self):
        ...
        for entry, stop, target, expected_rr in test_cases:
            ...
            if risk > 0:
                ...
                assert calculated_rr == pytest.approx(
                    expected_rr, abs=0.01
