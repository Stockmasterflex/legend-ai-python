...
def test_head_shoulders_top_detects_pattern():
    ...
    patterns = find_head_shoulders_top(opens, highs, lows, closes, volume, helpers, strict=False)
...
def test_head_shoulders_bottom_detects_pattern():
    ...
    patterns = find_head_shoulders_bottom(opens, highs, lows, closes, volume, helpers, strict=False)
